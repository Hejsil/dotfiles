...
seq 0 15 | xargs -I{} printf "base0%X\n" {} | while read BASE; do
    ...
    printf " -e s/{{$BASE-hex}}/$HEX/g"
    printf " -e s/{{$BASE-hex-r}}/$HEX_R/g"
    printf " -e s/{{$BASE-hex-g}}/$HEX_G/g"
    printf " -e s/{{$BASE-hex-b}}/$HEX_B/g"
    printf " -e s/{{$BASE-hex-bgr}}/$HEX_BGR/g"
    printf " -e s/{{$BASE-rgb-r}}/$RGB_R/g"
    printf " -e s/{{$BASE-rgb-g}}/$RGB_G/g"
    printf " -e s/{{$BASE-rgb-b}}/$RGB_B/g"
    printf " -e s/{{$BASE-dec-r}}/$DEC_R/g"
    printf " -e s/{{$BASE-dec-g}}/$DEC_G/g"
    printf " -e s/{{$BASE-dec-b}}/$DEC_B/g"
