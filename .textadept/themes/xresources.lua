...
local handle = io.popen("xrdb -query")
local result = handle:read("*a")
handle:close()

local map = {}
for key, r, g, b in result:gmatch('(color%d+):%s*#(%w%w)(%w%w)(%w%w)') do
  map[key] = tonumber(b .. g .. r, 16)
end

-- This is a workaround, as the colors in Xresources does not match base
-- numbers...
property['color.base00'] = map['color0']
property['color.base01'] = map['color18']
property['color.base02'] = map['color19']
property['color.base03'] = map['color8']
property['color.base04'] = map['color20']
property['color.base05'] = map['color7']
property['color.base06'] = map['color21']
property['color.base07'] = map['color15']
property['color.base08'] = map['color1']
property['color.base09'] = map['color16']
property['color.base0A'] = map['color3']
property['color.base0B'] = map['color2']
property['color.base0C'] = map['color14']
property['color.base0D'] = map['color4']
property['color.base0E'] = map['color5']
property['color.base0F'] = map['color17']
...
property['style.type'] = 'fore:%(color.base0B)'
